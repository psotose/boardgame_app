...
class BoardgamesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create boardgame" do
    assert_difference('Boardgame.count') do
      post boardgames_url, params: { boardgame: { name: @boardgame.name, rules: @boardgame.rules } }
    end
  ...
  test "should update boardgame" do
    patch boardgame_url(@boardgame), params: { boardgame: { name: @boardgame.name, rules: @boardgame.rules } }
